...
Opal.modules["corelib/string"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    def.$split = function(pattern, limit) {
      ...
      // --- debug : indexOf not found at JScript
...
if (arg == null) arg = nil;
  ...
  (($a = [typeof(process) === 'object' ? function(s){process.stdout.write(s)} : function(s){ }]), $b = $gvars.stdout, $b['$write_proc='].apply($b, $a), $a[$a.length-1]);
  (($a = [typeof(process) === 'object' ? function(s){process.stderr.write(s)} : function(s){}]), $b = $gvars.stderr, $b['$write_proc='].apply($b, $a), $a[$a.length-1]);
